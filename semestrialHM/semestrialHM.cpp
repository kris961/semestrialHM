...
int gradesMenu() {
    ...
    do {
        ...
        cin >> selection;//въвежда се избора на потребителя
        system("CLS");
    } while (selection > 3 || selection < 1);//върти цикъла докато не се въведе наличен избор
    return selection;//връща избора
}
...
int addStudentMenu() {
    ...
    do {
        ...
        cin >> selection;
        system("CLS");//изчиства конзолата
    } while (selection < 1 || selection>3);//върти цикъла докато не се въведе наличен избор
    return selection;//връща избора
}
...
int allInfoMenu() {
    ...
    do {
        ...
        cin >> selection;
        system("CLS");//изчиства конзолата
    } while (selection > 5 || selection < 1);//върти цикъла докато не се въведе наличен избор
    return selection;//връща избора
}
//създава нов студент
